...
<div>
    <form onSubmit={(e)=> AddPlayerHandler(e)} action="">
        <div className="formGroup">
            <input ref={fname} required type="text" className="control" placeholder='First Name' />
        </div>
        <div className="formGroup">
            <input ref={lname} required type="text" className="control" placeholder='Last Name' />
        </div>
        <div className="formGroup">
            <input ref={age} min="1.0" required type="number" className="control" placeholder='Height' />
        </div>
        <div className="formGroup">
